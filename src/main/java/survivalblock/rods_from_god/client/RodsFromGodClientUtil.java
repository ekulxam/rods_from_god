...
import survivalblock.atmosphere.atmospheric_api.not_mixin.render.BeaconLaserRenderer;
...
public class RodsFromGodClientUtil {
    ...
    public static void renderBeeeeeem(AbstractClientPlayerEntity clientPlayer, float tickDelta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider) {
        ...
        BeaconLaserRenderer.renderBeamTheRealWay(matrixStack, vertexConsumerProvider,
                BeaconBlockEntityRenderer.BEAM_TEXTURE, tickDelta, 1.0F, clientPlayer.getWorld().getTime(), 0, distance,
                16777215, 0.2F, 0.25F);
        matrixStack.pop();
    }
