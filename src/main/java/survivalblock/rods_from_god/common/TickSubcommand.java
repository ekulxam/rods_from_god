...
public enum TickSubcommand implements StringIdentifiable {
    ...
    private static final IntFunction<TickSubcommand> BY_ID = ValueLists.createIdToValueFunction((ToIntFunction<TickSubcommand>) Enum::ordinal, values(), ValueLists.OutOfBoundsHandling.ZERO);
