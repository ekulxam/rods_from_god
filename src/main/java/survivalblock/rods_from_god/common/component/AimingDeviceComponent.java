...
public class AimingDeviceComponent implements TooltipAppender {
    ...
    public static final PacketCodec<RegistryByteBuf, AimingDeviceComponent> PACKET_CODEC = AtmosphericPacketCodecUtil.tuple(
    ...
    public AimingDeviceComponent(int cooldown, int maxExplosions, int explosionPower, int inverseExplosionDamageFactor, double gravity, float scale, boolean createsFire) {
        ...
        this.maxExplosions = Optional.of(maxExplosions);
        this.explosionPower = Optional.of(explosionPower);
        this.inverseExplosionDamageFactor = Optional.of(inverseExplosionDamageFactor);
        this.gravity = Optional.of(gravity);
        this.scale = Optional.of(scale);
        this.createsFire = Optional.of(createsFire);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AimingDeviceComponent aimingDeviceComponent) {
            return (this.cooldown() == aimingDeviceComponent.cooldown())
                    && (this.maxExplosions() == this.maxExplosions())
                    && (this.explosionPower() == this.explosionPower())
                    && (this.inverseExplosionDamageFactor() == this.inverseExplosionDamageFactor())
