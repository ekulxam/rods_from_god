...
import survivalblock.atmosphere.atmospheric_api.not_mixin.entity.AtmosphericEntityUtil;
...
public class SolarLaserComponent implements CommonTickingComponent, AutoSyncedComponent {
    ...
    public void serverTick() {
        ...
        for (float step = 0; step * step < distance; step += 0.2f) {
            ...
            AtmosphericEntityUtil.getAndAddEntitiesToCollection(serverWorld, (entity -> entity instanceof LivingEntity && entity.getBoundingBox().intersects(box)), entities);
        }
    ...
    public boolean underTheSun(boolean accountForUltrawarm) {
        ...
        if (AtmosphericEntityUtil.isAffectedByDaylight(this.obj) && wasDay) {
            return true;
        }
