...
public class DeathExplosionComponent implements AutoSyncedComponent, CommonTickingComponent {
    ...
    public void explode() {
        ...
        serverWorld.createExplosion(this.obj, this.obj.getX(), this.obj.getY(), this.obj.getZ(), 8f, World.ExplosionSourceType.MOB);
        ...
        server.send(new ServerTask(server.getTicks(), () -> {
            ...
            boolean result =this.obj.damage(source, Float.MAX_VALUE);
            if (!result) {
                this.obj.kill();
            }
        }));
