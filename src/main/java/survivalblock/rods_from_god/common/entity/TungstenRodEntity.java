...
public class TungstenRodEntity extends Entity {
    ...
    public TungstenRodEntity(EntityType<?> type, World world) {
        super(type, world);
        this.attributes = new AttributeContainer(DefaultAttributeContainer.builder()
        ...
        if (world instanceof ServerWorld serverWorld) {
            ...
            if (this.groundCollision || this.isOnGround()) {
                ...
                affectedEntities.forEach((entity) -> {
                    ...
                    double distance = Math.abs(entityPosition.squaredDistanceTo(pos));
                    if (distance >= this.knockbackRadius) {
                        return;
                    }
                    ...
                    yeet.multiply(5 * ((this.knockbackRadius - distance) / 50));
