...
public class RodsFromGodDataComponentTypes {
    ...
    public static final ComponentType<SolarPrismHeadsetComponent> SOLAR_PRISM_HEADSET = ComponentType.<SolarPrismHeadsetComponent>builder().codec(SolarPrismHeadsetComponent.CODEC).packetCodec(SolarPrismHeadsetComponent.PACKET_CODEC).build();
    ...
    public static void init() {
        ...
        Registry.register(Registries.DATA_COMPONENT_TYPE, RodsFromGod.id("solar_prism_headset"), SOLAR_PRISM_HEADSET);
