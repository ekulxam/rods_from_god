...
public class RodsFromGodEntityTypes {
    ...
    public static final EntityType<BookEntity> BOOK = registerEntity("book", EntityType.Builder.<BookEntity>create(BookEntity::new, SpawnGroup.MISC).dimensions(0.8f, 0.5f));
