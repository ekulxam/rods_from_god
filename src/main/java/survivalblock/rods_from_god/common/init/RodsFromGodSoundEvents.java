...
public class RodsFromGodSoundEvents {
    ...
    public static final SoundEvent SOLAR_PRISM_HEADSET_AMBIENT = SoundEvent.of(RodsFromGod.id("item.rods_from_god.solar_prism_headset.ambient"));
    ...
    public static void init() {
        ...
        Registry.register(Registries.SOUND_EVENT, SOLAR_PRISM_HEADSET_AMBIENT.getId(), SOLAR_PRISM_HEADSET_AMBIENT);
    }
}
