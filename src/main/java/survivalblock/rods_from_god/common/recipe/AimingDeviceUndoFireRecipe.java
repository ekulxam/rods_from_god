...
public class AimingDeviceUndoFireRecipe extends SpecialCraftingRecipe {
    ...
    public ItemStack craft(CraftingRecipeInput input, RegistryWrapper.WrapperLookup lookup) {
        ...
        if (returnStack.contains(RodsFromGodDataComponentTypes.AIMING_DEVICE_CREATES_FIRE)) returnStack.remove(RodsFromGodDataComponentTypes.AIMING_DEVICE_CREATES_FIRE);
        return returnStack;
    }
